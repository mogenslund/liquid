...
Execute the program with:
    ...
    java -cp clojure-1.8.0.jar:liquid-0.8.2.jar clojure.main -m dk.salza.liq.core

To run as webserver use:

    java -cp clojure-1.8.0.jar:liquid-0.8.2.jar clojure.main -m dk.salza.liq.core --server --port=8520
...
For running in terminal and as serve at the same time use:
    ...
    java -cp clojure-1.8.0.jar:liquid-0.8.2.jar clojure.main -m dk.salza.liq.core --web --port=8520
